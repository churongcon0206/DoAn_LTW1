    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-right" id="myNavbar">
                ...
                <a href = "Favorite.php" style = "background-color:#fdfdfd; border : none; color : black;">
                ...
                $_SESSION['email'] = 'lqh2962000@gmail.com';
                ...
                if(isset($_SESSION['email']))
                {
                    ...
                    <div class="dropdown">
                      <button  style = "width : 20px; height : 20px;"class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                        
                            <div style = "width : 60px; height : 60px; border-radius : 20px; margin-top : -30px; margin-left : -20px;" class="image">
                      ...
                      <ul class="dropdown-menu" style = "width : 200px;">
                        <li >
                          <a href="profile.php">
                            <img src="SRC-Img/icon-profile.jpg" width="25px" />Profile</a>
                        </li>
                        <li >
                          <a href="Billing.php">
                            <img src="SRC-Img/icon-billing.jpg" width="25px" />Billing</a>
                        </li>
                        <li >
                          <a href="#">
                            <img src="SRC-Img/icon-logout.jpg" width="17px" />Logout</a>
                        </li>
                      </ul>
                    </div>
...
<!-- 
                                ...
                                <div style = "margin-top : -40px;" class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <img src="./SRC-Img/Avatar.jpg" alt="John Doe" />
                                        </div>
                                        <div class="content">
